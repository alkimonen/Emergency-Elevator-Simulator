...
HD_PWD='D:/Xilinx/project/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Elevator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Elevator.tcl
